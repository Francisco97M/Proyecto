...
class SignIn extends Component{
    ...
    handleSubmit = (e) => {
        e.preventDefault()
        axios.post('http://104.237.129.63:8009/api/register', this.state)
        .then(response => {
...
<h1>Login</h1>
<h3 className='did'>Already have an account or did you create one? Log in here!</h3>
<button className="appo"><Link to="/login">Log in</Link></button>
                ...
                <form id="my-form" onSubmit={this.handleSubmit}>
                    ...
                    <div class="col-25">
                        ...
                        onChange={this.handleChange}></input>
                                                <div class="col-25">   
                        <label><br/>Username<br/></label></div>
                        <input 
                        type='text'
                        value size = "60"
                        name='username'
